...
# reuse your hot runtime + Avatar from the updated module
from scripts.realtime_inference import inject_runtime, Avatar
...
async def infer(
    ...
    with tempfile.TemporaryDirectory() as tmpd:
        ...
        import types, scripts.realtime_inference as rt
    ...
    print(f"⏱️ /infer total: {(t1 - t0):.2f}s | avatar={avatar_id} fps={fps} prep={preparation}")
